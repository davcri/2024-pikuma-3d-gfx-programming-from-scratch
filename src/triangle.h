...
void draw_filled_triangle(int x0, int y0, float z0, float w0, int x1, int y1, float z1, float w1, int x2, int y2, float z2, float w2, Color_ui32 color);
...
void draw_triangle_pixel(int x, int y, Color_ui32 color, vec4_t point_a, vec4_t point_b, vec4_t point_c);
